...
#+author:Pinecone062
#+date:2020-03-21 21:43
#+macro:version Version 0.0.104
...
:appendix: t
:dependency1: "make"
:dependency2: "aws; AWS Account with ~/.aws/credentials and ~/.aws/config"
...
#+begin_src makefile
  ...
  # The AWS CLI Version 2 Bundled Installer
  # ---------------------------------------
  # The AWS CLI version 2 is available to install only as a bundled installer.
  ## https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2.html
  # The AWS CLI version 2 has no dependencies on other software
  # packages. It has a self-contained, embedded copy of all dependencies
  # included in the installer. You no longer need to install and
  # maintain Python to use the AWS CLI.

  # Install On Mac OS using the command-line
  # ----------------------------------------
  ## https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html

  # To install for all users using the macOS command line, run the following
  # commands, which install to the directory /usr/local/aws-cli and create
  # a symlink to the binary 'aws' in /usr/local/bin.  Following the install,
  # check that the install was successful by running 'which' and 'version'. 
  #/////////////////////////////////////////////////////////////////////////
  ...
  # Run this 'make' command to install the 'aws' command-line tools into
  #   /usr/local/aws-cli;
  # this will install the commands 'aws' and 'aws_completer' into
  #   /usr/local/bin
  # NOTE: the install script must be run as 'root' via 'sudo' on macos to install
  #       into /usr/local
  # USAGE: sudo make install-aws
  #        aws configure
