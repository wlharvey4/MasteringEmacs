...
# top-level domain suffix, e.g. .com, .net, .org, etc.
...
# SRC is HTML directory based upon the DIR name, i.e., with a trailing directory
# slash.
...
### AWS
### PROJ_LIST
# This contains the list of projects currently uploaded to
# the S3 bucket; each item contains the name of the project and its
# current version.
### S3PROJ
# The name and version of the current project as obtained from S3: 'proj-v1.2.34/'
...
# independent, dynamic code has replaced the static code.  The code
