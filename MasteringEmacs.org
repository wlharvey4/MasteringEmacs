...
#+author:Pinecone062
#+date:2021-01-30 22:42
#+macro:version Version 0.0.188
...
#+CINDEX: version
To check your Emacs' version, type:
...
The version can also be checked from within Emacs, using:
: M-x emacs-version
...
- ~user-emacs-directory~ :: src_elisp{(symbol-value 'user-emacs-directory)}
