...
#+author:Pinecone062
#+date:2020-11-10 07:31
#+macro:version Version 0.0.154
...
The following variables are user-customizable:

- [[custom-file-defvar][custom-file]]
...
#+texinfo: @heading Install Themes using Package Manager
...
#+texinfo: @heading Install New Themes by Hand
...
the following  procedure. Instead, write  something like the following  in your
init file:

: (setq custom-file "~/.emacs.d/themes/.emacs-custom.el")
: (load custom-file)
