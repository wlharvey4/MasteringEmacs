...
#+author:Pinecone062
#+date:2021-01-25 07:42
#+macro:version Version 0.0.182
...
* Emacs Display
Relating to the display that Emacs presents.
...
*** Macros Similar to ~with-output-to-temp-buffer
 ...
 #+begin_defmac
   ...
   - ACTION ::
     ...
     It passes the =ACTION= argument to ~display-buffer~ in order to display the
     buffer.
