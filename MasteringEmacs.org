...
- atom :: an atom is any object not a cons cell.
...
are two kinds of sequence in Emacs Lisp: “lists” and “arrays”.
...
A list can hold elements of any type, and its length can be easily changed by
...
Arrays are fixed-length sequences. They are further subdivided into strings,
