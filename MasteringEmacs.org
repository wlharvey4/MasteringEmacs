...
- [[*default-directory][~default-directory~]] --- a variable representing the current buffer's default directory

- [[*file-name-directory][~file-name-directory~]] --- a directory name (with a trailing slash =/=)
...
#+texinfo: :options default-directory
#+begin_defvar
