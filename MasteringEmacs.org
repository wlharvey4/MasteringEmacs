...
#+author:Pinecone062
#+date:2021-11-16 07:49
#+macro:version Version 0.0.198
...
*** TODO Next
1.  The CloudFront  configuration  needs to  be updated  to  recognize the  new
   version directory that is created as part of the ~sync~ operation.
