...
- Org Mode ::
  ...
  3. Find Org and install---current version is now 9.3.6
...
- Magit Mode ::
  ...
  1. M-x ~package-refresh-contents~
  2. M-x ~package-list-packages~
  3. Find Magit and install---current version is now
     : Magit 20200217.135, Git 2.17.2 (Apple Git-113), Emacs 27.0.50, darwin
  4. Install global key bindings to work with Magit from any buffer
